...
const Comuni = () => {
  ...
  const [showDppReceive, setShowDppReceive] = useState(false);
  const [showDppSend, setShowDppSend] = useState(false);
  ...
  const handleReceiveDpp = () => {
    setShowDppReceive(true);
    toast({
      title: "Ricevi DPP Prodotto",
      description: "Scansiona il QR code per ricevere le informazioni del prodotto"
    });
  };
  ...
  const handleSendDpp = () => {
    setShowDppSend(true);
    toast({
      title: "Invia DPP Prodotto",
      description: "Seleziona un prodotto dal tuo wallet per condividere il DPP"
    });
  };
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
          ...
          <Card className="border-0 shadow-xl bg-gradient-to-br from-purple-50 to-blue-50">
            <CardHeader className="bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-t-lg">
              ...
              <CardDescription className="text-purple-100">
                Ricevi e condividi informazioni sui prodotti tramite DPP
              </CardDescription>
            </CardHeader>
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Button 
                  ...
                  className="bg-green-600 hover:bg-green-700 text-white h-16 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-200"
                >
                ...
                <Button 
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white h-16 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-200"
                >
          ...
          <Card className="mb-6 border-green-200 bg-green-50">
            <CardHeader>
              <div className="flex justify-between items-center">
                <CardTitle className="text-green-800">Ricevi DPP Prodotto</CardTitle>
                <Button 
                  variant="outline" 
                  size="sm"
                  onClick={() => setShowDppReceive(false)}
                >
                  Chiudi
                </Button>
              </div>
        ...
        {showDppSend && (
          <Card className="mb-6 border-blue-200 bg-blue-50">
            <CardHeader>
              <div className="flex justify-between items-center">
                <CardTitle className="text-blue-800">Invia DPP Prodotto</CardTitle>
                <Button 
                  variant="outline" 
                  size="sm"
                  onClick={() => setShowDppSend(false)}
                >
                  Chiudi
                </Button>
              </div>
