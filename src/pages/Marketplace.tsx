...
import { Leaf, Gift, Star, ShoppingCart, ArrowLeft } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-emerald-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Scambia i Tuoi Punti 🎁</h2>
        ...
        <Tabs defaultValue="all" className="space-y-6">
          <TabsList className="grid w-full grid-cols-5 bg-white/80 backdrop-blur-sm">
            ...
            <TabsTrigger value="corporate">Aziendali</TabsTrigger>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-bold text-lg text-blue-600">{reward.cost} punti</span>
                      </div>
        ...
        {/* Bottom Info */}
        <div className="mt-12 bg-white/80 backdrop-blur-sm rounded-lg p-6 border-l-4 border-green-500">
